...
def getWordScore(word, n):
    ...
    value *= len(word)
    value += 50 if (len(usedLetters) == n) else 0
    ...
    while calculateHandlen(copy) > 0:
        ...
        if word == '.':
            ...
            if not isValidWord(word, hand, wordList):
                ...
                print('"' + str(word) + '" earned', end=" ")
                print(str(wordScore) + ' points.', end=" ")
...
def playGame(wordList):
    ...
    def ask():
        ...
        while response != 'e' and response != 'n' and response != 'r':
